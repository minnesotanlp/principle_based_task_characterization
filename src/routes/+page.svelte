...
<div>
    ...
    <p class="paper_detail" style="text-align: center; color: #363636; font-size: 12px;">Figure 1: Some principles are specific to that task. For a travel plan task, a user who asks LLM to design a travel schedule (input), require an output that adheres to certain principles.
...
<div>
    ...
    <div class="paper_detail">
        <ul>
            ...
            <p style="text-align: center; color: #363636; font-size: 12px;">
