...
<div>
    ...
    >
        <strong>Figure 3</strong>: LLM extracts principles from a given task, and then generates
        instances (input-output pairs) given the principles, and finally uses
        the principles to evaluate models' responses.
    </p>
    <div class="paper_detail">
        <ul>
            <li>
    ...
    <div class="paper_detail">
        <ul>
            ...
            <p
                style="text-align: center; color: #363636; font-size: 1em; margin-bottom: 10px"
            >
                <strong>Figure 4</strong>: Principle co-occurrences across three tasks. <br />
            ...
            <p
                style="text-align: center; color: #363636; font-size: 1em; margin-bottom: 10px"
            >
                <strong>Table 1</strong>: Cosine similarity between human-written, LLM-extracted,
                and LLM-generated principles.
            </p>
            <p>
                <span
                    style="display:inline-block; background-color: white; padding:4px 8px;"
            ...
            <p
                style="text-align: center; color: #363636; font-size: 1em; margin-bottom: 10px;"
            >
                <strong>Table 2</strong>: Comparison of Extracted and Generated Principles Data
                for task Travel Plan.
            </p>
            <p>
                <span
                    style="display:inline-block; background-color: white; padding:4px 8px;"
            ...
            <p
                style="text-align: center; color: #363636; font-size: 1em; margin-bottom: 10px;"
            >
                <strong>Table 3</strong>: Evaluation results on generated (Gen.) and extracted
                (Extr.) principles across LLMs.
